...
?>
	<div class="wrap">
		...
		<p class="welcome-text">
			<?php /* translators: %s theme name */
					printf( esc_html__( '%s theme is one of the most Popular Free WordPress theme of 2020-2021 years. To understand better what the theme can offer, please click the button below.', 'bard' ), esc_html( $theme_data->Name ) );
				?>
